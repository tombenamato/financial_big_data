...
# This version is a modification for the project. The original author is the following:
...
def get_rie(E, normalize=False, max_ones = True):
    ...
    T = 2500 #harcoded number of ticks we have per day approximately
    N = E.shape[0]
